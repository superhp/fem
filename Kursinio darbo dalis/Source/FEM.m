...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @FEM_OpeningFcn, ...
                   'gui_OutputFcn',  @FEM_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FEM is made visible.
function FEM_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);


% --- Outputs from this function are returned to the command line.
function varargout = FEM_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes during object creation, after setting all properties.
function bSpind_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
...
% --------------------------------------------------------------------
function bBgt_Callback(hObject, eventdata, handles)
    delete(gcf)
...
% --------------------------------------------------------------------
function pasirinkti_Callback(hObject, eventdata, handles)
    GVS.elem();
...
% --------------------------------------------------------------------
function einamasis_Callback(hObject, eventdata, handles)
    Grafika.Tinklelis;


% --------------------------------------------------------------------
function apie_Callback(hObject, eventdata, handles)
% hObject    handle to apie (see GCBO)
